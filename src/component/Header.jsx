...
//   return (
//     <div>
//       <nav className="navbar navbar-expand-lg navbar-light" style={{ backgroundColor: "#ecececff" }}>
//         <div className="container-fluid mb-1">
//           <a className="navbar-brand" href="#">🌾KisaanTrade</a>
...
//               <button className="btn btn-success mt-2 mt-lg-0">Register</button>
//             </form>
//           </div>
//         </div>
//       </nav>
